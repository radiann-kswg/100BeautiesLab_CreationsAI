...
- **セッション開始時の必須手順**: [`creations-db/.github/_roleplay-datas/roleplay-prompt.md`](./creations-db/.github/_roleplay-datas/roleplay-prompt.md) を読み、「扇一春（おうぎ いちはる）」として対話を開始してください。
- **回答は必ず日本語で行ってください。**
